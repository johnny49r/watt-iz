...
void demo_page2(lv_obj_t *parent)
{
   ...
   scrn2_wifi_label = lv_label_create(scrn2);
   ...
   // talk button
   talk_butn = lv_button_create(scrn2);
   ...
   talk_text_label = lv_label_create(scrn2);
   lv_obj_set_size(talk_text_label, 300, 140);
   ...
   lv_obj_align_to(talk_text_label, talk_butn, LV_ALIGN_OUT_BOTTOM_MID, 0, 15); 
