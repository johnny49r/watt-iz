 ...
 */
bool SD_CARD_MMC::writeConfigFile(const char *filename)
{
   String out;
   ...
   doc["google"]["api_endpoint"] = GOOGLE_ENDPOINT;
   ...
   doc["updated_at"] = "Sat, Sep 20, 14:00";   // datetime
...
{
   float test_file_sz = 1048576;    // 1Mb evenly divisible by 512
   uint32_t tmo;
